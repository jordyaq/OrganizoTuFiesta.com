...
<body>
    ...
    <header>
        <div class="menu">
            <div class="contenedor">
                ...
                <img class="menu-icon" src="images/menu.png" alt="Menu celular">
                <nav>
                    <ul>
        ...
        <div class="contenedor" id="contenedor-titulo-flex">
            <div class="contenedor-titulo">
                ...
                <h2>Organización de eventos y fiestas de todo tipo</h2>
    ...
    <main>
        ...
        <section id="contacto">
            <div class="contenedor">
                ...
                <h3>Recibimos tu mensaje, nos contactamos enseguida.</h3>
    ...
    <footer>
        <div class="contenedor">
            <div class="redes"></div>
            <div class="parrafo"><p>2020 OrganizoTuFiesta.com, Organización de eventos de todo tipo, CDMX</p></div>
        </div>
    </footer>
